...
$designexo_testimonial_area_des = get_theme_mod('designexo_testimonial_area_des', __('What Customer Say About Us','arile-extra'));
}
...
?>
<section class="theme-block theme-testimonial <?php if('Interior Dark' == $activate_theme || 'InteriorX' == $activate_theme || 'Interior Decor' == $activate_theme || 'Interior Trends' == $activate_theme){ echo 'vrsn-three'; }else{ echo 'vrsn-two'; } ?>" id="theme-testimonial">	
				    ...
				    <div class="col-lg-4 col-md-6 col-sm-12">
						<article class="theme-testimonial-block vrsn-two wow animate fadeInUp" data-wow-delay=".3s">
							...
							<?php if('BeautyCare' == $activate_theme){ ?>
									<figure class="thumbnail">
										<img src="<?php echo arile_extra_plugin_url; ?>/inc/designexo/images/theme-user5.jpg" class="img-fluid rounded-circle" alt="Mitchell Harris">
									</figure>
							<?php }else { ?>	
                                    <figure class="thumbnail">
										<img src="<?php echo arile_extra_plugin_url; ?>/inc/designexo/images/theme-user2.jpg" class="img-fluid rounded-circle" alt="Mitchell Harris">
							...
							<?php } ?>	
									<div class="media-body align-self-center"><?php if('BeautyCare' == $activate_theme){ ?>
										<cite class="name"><?php esc_html_e('Anna Parker','arile-extra'); ?></cite>
									<?php }else { ?>
