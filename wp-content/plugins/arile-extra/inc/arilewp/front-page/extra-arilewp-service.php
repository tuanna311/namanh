...
if('Agency Street' == $activate_theme){
	$arilewp_service_area_title = get_theme_mod('arilewp_service_area_title', __('Our Features','arile-extra'));
	$arilewp_service_area_des = get_theme_mod('arilewp_service_area_des', __('<b>We offer many </b> services to growth','arile-extra'));
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php if($arilewp_service_area_title != null): ?>
						<p class="theme-section-subtitle wow animate fadeInLeft" data-wow-delay=".3s"><?php echo wp_kses_post($arilewp_service_area_title); ?></p>
					<?php endif; ?>
					<?php if($arilewp_service_area_des != null): ?>
						<h2 class="theme-section-title wow animate fadeInRight" data-wow-delay=".3s"><?php echo wp_kses_post($arilewp_service_area_des); ?></h2>
					<?php endif; ?>
		...
		?>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="<?php if($activate_theme != 'Business Street' && $activate_theme != 'DesignHub' && $activate_theme != 'Agency Street' && $activate_theme != 'Sayre' && $activate_theme != 'Hague Firm'){echo 'service-content text-center';}else{echo 'service-content-two media';} ?>">
						...
						<?php } elseif('Alberta' == $activate_theme || 'Etowah' == $activate_theme){ ?>
							<a href="#"><img class="img-fluid" src="<?php echo arile_extra_plugin_url; ?>/inc/arilewp/images/theme-service7.jpg" alt="Architectural Design" title="Architectural Design"></a>
						<?php } elseif('Agency Firm' == $activate_theme){ ?>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="<?php if($activate_theme != 'Business Street' && $activate_theme != 'DesignHub' && $activate_theme != 'Agency Street' && $activate_theme != 'Sayre' && $activate_theme != 'Hague Firm'){echo 'service-content text-center';}else{echo 'service-content-two media';} ?>">
						...
						<?php } elseif('Alberta' == $activate_theme || 'Etowah' == $activate_theme){ ?>
							<a href="#"><img class="img-fluid" src="<?php echo arile_extra_plugin_url; ?>/inc/arilewp/images/theme-service8.jpg" alt="Architectural Design" title="Architectural Design"></a>
						<?php } elseif('Agency Firm' == $activate_theme){ ?>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="<?php if($activate_theme != 'Business Street' && $activate_theme != 'DesignHub' && $activate_theme != 'Agency Street' && $activate_theme != 'Sayre' && $activate_theme != 'Hague Firm'){echo 'service-content text-center';}else{echo 'service-content-two media';} ?>">
						...
						<?php } elseif('Alberta' == $activate_theme || 'Etowah' == $activate_theme){ ?>
							<a href="#"><img class="img-fluid" src="<?php echo arile_extra_plugin_url; ?>/inc/arilewp/images/theme-service9.jpg" alt="Architectural Design" title="Architectural Design"></a>
						<?php } elseif('Agency Firm' == $activate_theme){ ?>
