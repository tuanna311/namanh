...
<!-- Theme info Area -->
<div class="container <?php if('EnvoPress' == $activate_theme || 'Arvada' == $activate_theme || 'EarnPress' == $activate_theme || 'ConsultZone' == $activate_theme || 'ConsultHub' == $activate_theme || 'ConsultGuide' == $activate_theme || 'Architect Hub' == $activate_theme){echo 'vrsn-two';}?>" id="theme-info-area">
				...
				<?php } } else { ?>
						<div class="col-lg-4 col-md-6 col-xs-12 wow animate zoomIn" data-wow-delay=".3s">
							<div class="media">
								...
								<div class="media-body align-self-center">
								<?php if('Business Stock' == $activate_theme){ ?>
									<h5 class="theme-info-area-title"><?php esc_html_e('Growing Business','arile-extra'); ?></h5>
								<?php }else{ ?>	
				    ...
				    <?php if('Decorexo' == $activate_theme){ ?>
						<div class="col-lg-4 col-md-6 col-xs-12 wow animate zoomIn" data-wow-delay=".3s">
							<div class="media">
								...
								<div class="media-body align-self-center">
									<h5 class="theme-info-area-title"><?php esc_html_e('Interior Solutions','arile-extra'); ?></h5>
