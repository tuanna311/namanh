...
if('Agency Street' == $activate_theme){
	$arilewp_testimonial_area_title = get_theme_mod('arilewp_testimonial_area_title', __('Our Testimonials','arile-extra'));
	...
	$arilewp_testimonial_area_title = get_theme_mod('arilewp_testimonial_area_title', __('Client Feedback','arile-extra'));
	$arilewp_testimonial_area_des = get_theme_mod('arilewp_testimonial_area_des', __('<b>Happy Words From</b> Happy Customer','arile-extra'));
}else{
