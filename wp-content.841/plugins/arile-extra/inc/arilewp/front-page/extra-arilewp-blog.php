...
if('Agency Firm' == $activate_theme){
	$arilewp_blog_area_title = get_theme_mod('arilewp_blog_area_title', __('Our Blog','arile-extra'));
	$arilewp_blog_area_des = get_theme_mod('arilewp_blog_area_des', __('<b>Digital World</b> News' ,'arile-extra'));
}else{
	 ...
	 <?php if($arilewp_blog_area_title != null || $arilewp_blog_area_des != null): ?>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php if($arilewp_blog_area_title != null): ?>
						<p class="theme-section-subtitle wow animate fadeInLeft" data-wow-delay=".3s"><?php echo wp_kses_post($arilewp_blog_area_title); ?></p>
					<?php endif; ?>
					<?php if($arilewp_blog_area_des != null): ?>
						<h2 class="theme-section-title wow animate fadeInRight" data-wow-delay=".3s"><?php echo wp_kses_post($arilewp_blog_area_des); ?></h2>
					<?php endif; ?>
        ...
        $post_args = array( 'post_type' => 'post', 'category__in' => $arilewp_theme_blog_category, 'post__not_in'=>get_option("sticky_posts")) ;
			...
			{	
				...
				{ ?>
					<div class="col-lg-<?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress' || $activate_theme == 'InnoPress' || 'Interior Startup' == $activate_theme || 'Agency Firm' == $activate_theme || 'Interior Space' == $activate_theme) { echo '6'; } elseif($activate_theme == 'Architect Design' || $activate_theme == 'Ariletech' || $activate_theme == 'DesignHub' || $activate_theme == 'Alberta' || $activate_theme == 'Agency Street' || 'Etowah' == $activate_theme || 'Roseville Blog' == $activate_theme || 'Zervin' == $activate_theme || 'Interior Craft' == $activate_theme) { echo '4'; } else { echo '3';}   ?> col-md-6 col-sm-12">
