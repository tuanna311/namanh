...
<!-- Theme info Area -->
<section class="theme-info-area <?php if('Interior Dark' == $activate_theme || 'InteriorX' == $activate_theme || 'Interior Decor' == $activate_theme || 'Interior Trends' == $activate_theme || 'CreationWP' == $activate_theme){ echo 'vrsn-two'; } ?>" id="theme-info-area">
<div class="container" >
	<div class="row">
				<?php 
				...
				<?php } } else { ?>
				    <?php if('Designexo' == $activate_theme || 'InteriorWP' == $activate_theme || 'Designexo Child Theme' == $activate_theme || 'Architects' == $activate_theme || 'Interior Dark' == $activate_theme || 'InteriorX' == $activate_theme || 'CreationWP' == $activate_theme || 'Designarch' == $activate_theme){ ?>
						...
						<div class="col-lg-3 col-md-6 col-xs-12">
							<div class="media wow animate flipInX" data-wow-delay=".3s">
								...
								<div class="media-body align-self-center">
							    <?php if('Architects' == $activate_theme || 'Designarch' == $activate_theme){  ?>
					...
					<?php if('Empresa' == $activate_theme || 'Technoex' == $activate_theme || 'Elevora Dark' == $activate_theme){ ?>
						<div class="col-lg-4 col-md-6 col-xs-12">
							<div class="media wow animate flipInX" data-wow-delay=".3s">
